    ...
    assets =
      quote do
        scope "/__beacon_live_admin/assets", alias: false, as: false do
          ...
          get "/css-site-:md5/:site", Beacon.LiveAdmin.AssetsController, :css_site, as: :beacon_live_admin_asset
          get "/css-page-:md5/:site/:page_id", Beacon.LiveAdmin.AssetsController, :css_page, as: :beacon_live_admin_asset
