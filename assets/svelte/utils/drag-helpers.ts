...
export function updateSelectedElementMenu(mouseMovement = null) {
  ...
  let elementCoords: CoordsDiff = (menu && mouseMovement) ? menu.elementCoords : { start: currentCoords, current: currentCoords };
  ...
  selectedElementMenu.set({ top, left, elementCoords, dragDirection, dragging: !!mouseMovement, mouseMovement, insertBefore });
}
